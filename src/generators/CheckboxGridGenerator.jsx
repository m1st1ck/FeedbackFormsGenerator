...
function CheckboxGridGenerator({ question, onChange }) {
  console.log("render CheckboxGridGenerator");
      ...
      <Box flexDirection="row" display="flex">
        <Box flexDirection="column" display="flex">
          {[...options, ""].map((option, index) => {
            return (
              <Box
                key={index} // TODO: change from index to something else, not option
                flexDirection="row"
                display="flex"
                alignItems="center"
              >
...
export default React.memo(CheckboxGridGenerator, areGeneratorStatesEqual);
